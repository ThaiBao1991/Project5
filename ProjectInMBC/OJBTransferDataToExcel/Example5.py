...
Layout = [      
        ...
        [sg.InputText(disabled=True,size=(50, 1), key='form_OJB'),sg.FilesBrowse(key='form_OJB_choose')],
        ...
        [sg.InputText(justification='center',disabled=True,size=(50, 1), key='form_save',enable_events=True),sg.FilesBrowse(key='form_save_choose')],
        
        [sg.Text("Nhập số lượng dòng dữ liệu :",font=('Helvetica', 11,'bold')),sg.InputText(default_text="10",justification="center",disabled=False,size=(20,1),key="number_of_data")],
        ...
        [sg.Button('Update',key="Start", size=(15, 2), button_color=('green', 'grey'), font=('Helvetica', 16,'bold'), pad=(40, 40),enable_events=True),
            sg.Button('Open', size=(15,2),button_color=('yellow','grey'),enable_events=True,font=('Helvetica',16,'bold'),pad=(40, 40)),
            sg.Button('Close', size=(15, 2), button_color=('red', 'grey'), font=('Helvetica', 16,'bold'), pad=(40, 40),enable_events=True)],

        [sg.Text("VDM-Inspection Section 2024/04",font=('Helvetica',8))]    
    ]
...
while True:
    ...
    if event == sg.WIN_CLOSED:
        ...
        if not form_category:
            ...
            saved = False
            if form_category in data:
                if form_category == "Y-101-Program G (Item 01+02) Shaft position":
                                ...
                                if form_category in data:
                                    ...
                                    if code and code != "":
                                        ...
                                        if form_category == "Y-101-Program G (Item 01+02) Shaft position":
                                            ...
                                            sg.Popup('Hoàn thành copy dữ liệu từ file Y-101-Program G (Item 01+02) Shaft position', keep_on_top=True)
                                else:
                                        if form_category == "Y-101-Program G (Item 01+02) Shaft position":
                                            copy_from_excel_to_excel_vertical(file_OJP_path,"L15",file_save_path,"O54",number_data)
                                            copy_from_excel_to_excel_vertical(file_OJP_path,"O15",file_save_path,"T54",number_data)
